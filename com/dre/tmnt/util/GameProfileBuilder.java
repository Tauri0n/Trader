...
public class GameProfileBuilder {
	 ...
	 * @see GameProfile
	 */
	public static GameProfile fetch(UUID uuid, String newName) throws IOException {
		return fetch(uuid, false, newName);
	}
	 ...
	 * @see GameProfile
	 */
	public static GameProfile fetch(UUID uuid, boolean forceNew, String name) throws IOException {
